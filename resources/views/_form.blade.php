    ...
    <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" value="{{ @$diarista->cep }}" class="form-control" id="cep" name="cep" maxlength="50">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="file" accept=".jpg,.png|image/*" class="form-control" id="foto_usuario" name="foto_usuario" >
        </div>
